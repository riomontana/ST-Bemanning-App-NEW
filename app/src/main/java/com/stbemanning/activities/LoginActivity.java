...
import com.stbemanning.tasks.RegisterTokenTask;
...
//        getSupportActionBar().hide();
    ...
    public void apiResponse(JSONObject response) {
        ...
        try {
            ...
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
            String appToken = prefs.getString("REG_TOKEN", "empty");

            Log.d("START_TASK", userId + ", " + appToken);
            new RegisterTokenTask().execute(String.valueOf(userId), appToken);
